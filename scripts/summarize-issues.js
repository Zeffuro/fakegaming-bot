...
export function parseIssuesTodo(content) {
...
export function formatSummary(summary) {
    ...
    const statusOrder = ['PENDING', 'IN_PROGRESS', 'DONE', 'DEFERRED'];
    ...
    for (const t of nextP0)
        lines.push(`  ${t.substring(2)}`); // remove bullet prefix
    return lines.join('\n');
}
async function main() {
    try {
