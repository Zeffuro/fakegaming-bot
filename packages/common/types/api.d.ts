export interface paths {
    ...
    "/userSettings": {
        ...
        /** Get personal settings for the authenticated dashboard user */
        get: {
            parameters: {
                query?: never;
                header?: never;
        ...
        options?: never;
        head?: never;
        /** Update personal settings for the authenticated dashboard user */
        patch: {
            parameters: {
                query?: never;
                header?: never;
    ...
    "/userReminders": {
        ...
        /** List reminders for the authenticated dashboard user */
        get: {
            parameters: {
                query?: never;
                header?: never;
        ...
        put?: never;
        /** Create a reminder for the authenticated dashboard user */
        post: {
            parameters: {
                query?: never;
                header?: never;
            ...
            requestBody: {
                content: {
                    "application/json": components["schemas"]["UserReminderCreateRequest"];
                };
            };
            responses: {
    ...
    "/userReminders/{id}": {
        ...
        /** Get one reminder for the authenticated dashboard user */
        get: {
            parameters: {
                query?: never;
                header?: never;
        ...
        put?: never;
        post?: never;
        /** Delete one reminder for the authenticated dashboard user */
        delete: {
            parameters: {
                query?: never;
                header?: never;
    ...
    "/userReminders/{id}/snooze": {
        ...
        options?: never;
        head?: never;
        /** Snooze one reminder for the authenticated dashboard user */
        patch: {
            parameters: {
                query?: never;
                header?: never;
            ...
            requestBody: {
                content: {
                    "application/json": components["schemas"]["UserReminderSnoozeRequest"];
                };
            };
            responses: {
    ...
    "/rolePermissionSnapshots": {
        ...
        /** List saved role and channel permission snapshots for a guild */
        get: {
            parameters: {
                query: {
                    guildId: string;
    ...
    "/rolePermissionSnapshots/live": {
        ...
        /** Read the current role and channel permission state from Discord */
        get: {
            parameters: {
                query: {
                    guildId: string;
        ...
        put?: never;
        /** Save a current role and channel permission snapshot from Discord */
        post: {
            parameters: {
                query: {
                    guildId: string;
    ...
    "/rolePermissionSnapshots/{id}": {
        ...
        /** Read one saved role and channel permission snapshot */
        get: {
            parameters: {
                query: {
                    guildId: string;
