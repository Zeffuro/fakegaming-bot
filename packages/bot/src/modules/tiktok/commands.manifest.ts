...
export const manageTikTokStreams = { name: 'manage-tiktok-streams', description: 'List, test, pause, resume, or remove TikTok live notifications', permissions: 'Administrator' } as const;
