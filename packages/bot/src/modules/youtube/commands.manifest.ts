...
export const manageYoutubeChannels = { name: 'manage-youtube-channels', description: 'List, test, pause, resume, or remove YouTube video notifications', permissions: 'Administrator' } as const;
