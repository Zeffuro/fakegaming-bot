...
export const occupyChannel = { name: 'occupy-channel', description: 'Keep a voice channel occupied while the bot is online', permissions: 'Administrator', dm_permission: false, default_member_permissions: '8' } as const;
