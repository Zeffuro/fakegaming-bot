...
export const manageBlueskyAccounts = { name: 'manage-bluesky-accounts', description: 'List, test, pause, resume, or remove Bluesky post notifications', permissions: 'Administrator' } as const;
